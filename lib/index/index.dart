      ...
      return new GestureDetector(
        onTap: (){
          Navigator.of(context).push(
              MaterialPageRoute(builder: (context)=>DetailsWidget(value))
          );
        },
        child:new Container(
                  ...
                  return new Builder(
                    builder: (BuildContext context) {
                      return new GestureDetector(
                        onTap: (){
                          Navigator.of(context).push(
                              MaterialPageRoute(builder: (context)=>DetailsWidget(banner))
                          );
                        },
                        child: new Container(
                            ...
                            child: new Stack(
                              ...
                              children: <Widget>[
                                ...
                                new Container(
                                  ...
                                  child:Text(banner['title'],style: TextStyle(fontSize: 18.0,color:Colors.white,),),
                                  alignment: Alignment.center,
                                )
                              ],
                            )
